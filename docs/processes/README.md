...
| [e2e-smoke.md](./e2e-smoke.md) | API/E2E smoke gates (SQL + languages + adaptive Today + guided practice + catalog orchestrator) |
...
| [english-guided-practice-v1.md](./english-guided-practice-v1.md) | **Active** P2 English unit-guided practice contract, fallback, AI/evidence boundaries |
