...
.DESCRIPTION
  ...
  English Guided Practice P2.0 E2E, and Adaptive Today E2E. Optional -IncludeSandboxes also runs JS/HTMLCSS sandbox scripts.
...
Step "English Guided Practice P2.0 E2E"
& (Join-Path $PSScriptRoot "e2e-guided-practice.ps1") -BaseUrl $BaseUrl
if ($LASTEXITCODE -ne 0) { Fail "e2e-guided-practice.ps1 exited $LASTEXITCODE" }
