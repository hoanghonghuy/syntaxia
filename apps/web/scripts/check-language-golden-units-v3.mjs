...
const migratedUnits = [
  ...
  {
    track: 'chinese-hsk',
    unitId: 'zh-hsk-b1-study-04',
    unitOrder: '4',
    nodes: [
      ['time-of-day', 'lesson'],
      ['school-daily', 'lesson'],
      ['study-checkpoint', 'checkpoint'],
      ['study-review', 'review'],
    ],
  },
  {
    track: 'chinese-hsk',
    unitId: 'zh-hsk-b1-counter-05',
    unitOrder: '5',
    nodes: [
      ['food-drink', 'lesson'],
      ['counter-checkpoint', 'checkpoint'],
      ['counter-review', 'review'],
    ],
  },
  {
    track: 'chinese-hsk',
    unitId: 'zh-hsk-b1-info-06',
    unitOrder: '6',
    nodes: [
      ['places', 'lesson'],
      ['questions', 'lesson'],
