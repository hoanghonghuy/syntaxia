...
INSERT INTO tracks (id, title, description, category, level, sort_order) VALUES
    ...
    ('chinese-hsk', '{"en":"Chinese (HSK)","vi":"Tiếng Trung (HSK)"}', '{"en":"Practical Mandarin Level 1 foundation with Pinyin/tone prerequisites, everyday communication, and spaced review.","vi":"Nền tảng tiếng Trung Level 1 thực dụng với Pinyin/thanh điệu, giao tiếp đời sống và ôn tập giãn cách."}', 'languages', 'basic', 100),
    ('english-basics', '{"en":"English Basics","vi":"Tiếng Anh cơ bản"}', '{"en":"CEFR A1 language foundation with pronunciation, core sentence grammar, everyday interaction, and spaced review.","vi":"Nền tảng tiếng Anh CEFR A1 gồm phát âm, ngữ pháp tạo câu cốt lõi, giao tiếp đời sống và ôn tập giãn cách."}', 'languages', 'basic', 110),
    ('japanese-jlpt', '{"en":"Japanese (JLPT)","vi":"Tiếng Nhật (JLPT)"}', '{"en":"JLPT N5 practical foundation with daily-life/classroom communication, kana readings, and spaced review.","vi":"Nền tảng tiếng Nhật JLPT N5 thực dụng với giao tiếp đời sống/lớp học, cách đọc kana và ôn tập giãn cách."}', 'languages', 'basic', 120),
    ('chinese-it-vocab', '{"en":"Chinese IT Vocab","vi":"Từ vựng IT tiếng Trung"}', '{"en":"Optional Chinese workplace-technology specialty course with contextual terminology practice.","vi":"Chuyên đề tùy chọn về tiếng Trung công nghệ tại nơi làm việc, luyện thuật ngữ trong ngữ cảnh."}', 'languages', 'basic', 130)
