# Learning shell IA — behavioral spec
...
### REQ-SHELL-FOOTER-001 Four-tab mobile footer
...
### REQ-SHELL-FOOTER-002 Guest-aware account tab
...
### REQ-SHELL-NAV-003 Lesson-nav affordance

**When** on a track hub or lesson on mobile  
**Then** lesson sidebar opens via header hamburger and/or footer Lessons (Mintlify)  
**And** a third duplicate “open lessons” ghost control is not shown on the track hub

### REQ-HOME-004 Slim home composition
